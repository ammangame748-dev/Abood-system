...
<title>ABOUD SYSTEM · الدخول</title>
...
<style id="aboud-system-theme">
:root{
  --ink:#070b18;--panel:#0d1428;--panel-2:#111c35;--panel-3:#162544;
  --line:rgba(117,144,255,.20);--line-strong:rgba(104,224,255,.52);
  --gold:#73e5ff;--gold-2:#7267ff;--red:#ff668f;--red-soft:rgba(255,102,143,.14);
  --muted:#8998ba;--text:#edf5ff;--shadow:0 24px 80px rgba(0,0,0,.38);
}
html{background:#070b18;scroll-behavior:smooth}
body{background:radial-gradient(circle at 10% 0%,rgba(114,103,255,.22),transparent 31%),radial-gradient(circle at 90% 18%,rgba(80,225,255,.12),transparent 28%),linear-gradient(145deg,#070b18 0%,#0a1124 45%,#071526 100%);}
body:before{opacity:.28;background-image:linear-gradient(rgba(122,158,255,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(122,158,255,.045) 1px,transparent 1px);background-size:48px 48px;mask-image:linear-gradient(to bottom,#000,transparent 90%)}
body:after{content:'';position:fixed;inset:0;pointer-events:none;z-index:0;background:radial-gradient(circle at 70% 70%,rgba(115,229,255,.07),transparent 24%)}
.login-shell,.app{position:relative;z-index:1}
.login-shell{background:rgba(9,16,35,.82);border-color:var(--line-strong);box-shadow:0 30px 110px rgba(0,0,0,.58);backdrop-filter:blur(24px)}
.brand-panel{background:linear-gradient(145deg,rgba(114,103,255,.28),rgba(9,16,35,.78) 52%,rgba(80,225,255,.08));border-color:var(--line)}
.brand-panel:after{content:'A';color:rgba(115,229,255,.07)}
.brand-panel h1{background:linear-gradient(110deg,#ffffff 4%,#73e5ff 42%,#8c7dff 83%);-webkit-background-clip:text}
.micro,.eyebrow,.panel-kicker{color:var(--gold)}
.system-list span{background:rgba(116,125,255,.09);border-color:var(--line);color:#d7e5ff}
.login-panel{background:rgba(5,10,25,.62)}
.discord-button,.btn-save{background:linear-gradient(120deg,#6ee7ff,#8b82ff);color:#071021;box-shadow:0 12px 30px rgba(103,210,255,.18)}
.discord-button:hover,.btn-save:hover{box-shadow:0 18px 42px rgba(103,210,255,.32)}
.secure-note i,.status-dot{background:#58f0bf;box-shadow:0 0 14px #58f0bf}
.rail{background:linear-gradient(180deg,rgba(10,17,38,.98),rgba(5,10,24,.99));border-color:var(--line);box-shadow:-20px 0 70px rgba(0,0,0,.32)}
.brand{border-color:var(--line)}
.brand-mark{width:44px;height:44px;border-radius:15px;background:linear-gradient(135deg,#73e5ff,#7267ff 78%);color:#071021;letter-spacing:-1px;box-shadow:0 10px 28px rgba(104,180,255,.26)}
.brand strong{letter-spacing:1px;font-size:16px;color:#f4f8ff}
.brand small{color:#7fdfff}
.rail-section{color:#6c7da8}
.rail-link{color:#9caaca;border-radius:14px;min-height:45px}
.rail-link:hover{background:rgba(111,137,255,.11);color:#f4f8ff;transform:translateX(-4px)}
.rail-link.is-active{background:linear-gradient(100deg,rgba(115,229,255,.18),rgba(114,103,255,.12));border-color:var(--line-strong);color:var(--gold);box-shadow:inset -3px 0 var(--gold),0 8px 26px rgba(76,119,255,.10)}
.rail-link.is-active i{background:var(--gold);box-shadow:0 0 14px var(--gold)}
.rail-footer{border-color:var(--line)}.rail-footer a{color:#ff7699}
.workspace{position:relative;z-index:1}
.topbar{border-color:var(--line);background:rgba(7,13,30,.70);box-shadow:0 12px 36px rgba(0,0,0,.14)}
.menu-btn{border-color:var(--line);background:var(--panel);color:var(--gold)}
.menu-btn svg,.top-actions svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}
.top-actions a{border-color:var(--line);border-radius:12px;background:rgba(115,229,255,.035)}
.top-actions a:hover{color:var(--gold);border-color:var(--line-strong);background:rgba(115,229,255,.10);transform:translateY(-2px)}
.welcome-strip{background:linear-gradient(110deg,rgba(114,103,255,.23),rgba(12,23,48,.90) 49%,rgba(80,225,255,.08)),var(--panel);border-color:var(--line-strong);border-radius:24px;box-shadow:var(--shadow);padding:34px 36px}
.welcome-strip:before{content:'';position:absolute;inset:auto 0 0;height:2px;background:linear-gradient(90deg,transparent,#7267ff,#73e5ff,transparent);opacity:.9}
.welcome-strip:after{content:'A';color:rgba(115,229,255,.07);font-size:190px}
.welcome-strip h1{font-size:32px;letter-spacing:-.8px;color:#f6f9ff}
.welcome-meta{padding:9px 13px;border:1px solid var(--line);border-radius:999px;background:rgba(7,15,34,.46);color:#a8f2ff}
.card{background:linear-gradient(145deg,rgba(20,35,66,.88),rgba(8,16,34,.94));border-color:var(--line);border-radius:20px;box-shadow:0 14px 50px rgba(0,0,0,.22)}
.card:hover{border-color:var(--line-strong);transform:translateY(-1px)}
.card h3{color:#f3f7ff}.card h3 svg{color:var(--gold)}
label{color:#afbdd8}input,select,textarea{background:rgba(4,10,24,.78);border-color:rgba(122,158,255,.18);color:#f1f6ff}input:focus,select:focus,textarea:focus{border-color:var(--gold);box-shadow:0 0 0 3px rgba(115,229,255,.12)}
.btn-danger{background:linear-gradient(135deg,#ff668f,#ba4dff)!important}
.tag-blue{background:rgba(115,229,255,.12);color:#8eeeff;border-color:var(--line)}.tag-red{background:var(--red-soft);color:#ff91aa;border-color:rgba(255,102,143,.25)}
.data-table{border-color:var(--line)}.data-table th{background:rgba(115,229,255,.08);color:#8eeeff}.data-table td{border-color:rgba(122,158,255,.10);color:#cbd7ec}
.stats-grid{gap:16px}.stat-box{background:linear-gradient(145deg,rgba(91,111,255,.12),rgba(255,255,255,.02));border-color:var(--line);position:relative;overflow:hidden}.stat-box:after{content:'';position:absolute;inset:auto -20px -32px auto;width:100px;height:100px;border-radius:50%;background:rgba(115,229,255,.08);filter:blur(4px)}.stat-num{color:#8eeeff;text-shadow:0 0 22px rgba(115,229,255,.24)}
.guild-card{background:linear-gradient(145deg,rgba(20,35,66,.86),rgba(8,16,34,.94));border-color:var(--line)}.guild-card:hover{border-color:var(--gold);box-shadow:0 18px 38px rgba(71,140,255,.16)}
.toggle-row{border-color:rgba(122,158,255,.10)}.toggle-row input[type=checkbox]{accent-color:var(--gold)}
.range-controls{gap:18px;margin-top:20px;padding:16px;border:1px solid var(--line);border-radius:16px;background:rgba(5,12,28,.48)}
.range-controls label{margin:0;padding:2px 0;color:#bcd0ef}.range-controls output{float:left;min-width:52px;text-align:center;padding:3px 8px;border-radius:8px;background:rgba(115,229,255,.10);color:#8eeeff;font:700 10px 'IBM Plex Mono',monospace}
.range-controls input[type=range]{appearance:none;height:6px;padding:0;margin-top:12px;border:0;border-radius:99px;background:linear-gradient(90deg,#73e5ff 0%,#7267ff 50%,#152747 50%,#152747 100%);box-shadow:none;cursor:pointer}
.range-controls input[type=range]::-webkit-slider-thumb{appearance:none;width:18px;height:18px;border:3px solid #071021;border-radius:50%;background:#73e5ff;box-shadow:0 0 0 3px rgba(115,229,255,.24),0 4px 12px rgba(0,0,0,.35)}
.range-controls input[type=range]::-moz-range-thumb{width:14px;height:14px;border:3px solid #071021;border-radius:50%;background:#73e5ff;box-shadow:0 0 0 3px rgba(115,229,255,.24)}
.welcome-preview{border-color:var(--line-strong);box-shadow:inset 0 0 0 1px rgba(115,229,255,.08),0 18px 46px rgba(0,0,0,.24)}
.preview-avatar{border-color:#73e5ff;box-shadow:0 0 0 5px rgba(115,229,255,.15),0 10px 28px rgba(0,0,0,.4)}.preview-avatar button{border-color:#73e5ff;background:#0b1730;color:#73e5ff}
.editor-badge{border-color:var(--line-strong);color:#8eeeff;background:rgba(115,229,255,.06)}

.system-ribbon{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:-16px 0 24px;padding:10px 13px;border:1px solid var(--line);border-radius:14px;background:rgba(9,19,42,.58);color:#a9b8d7;font-size:10px}
.system-ribbon span{display:inline-flex;align-items:center;gap:7px;padding-left:11px;border-left:1px solid rgba(122,158,255,.16)}
.system-ribbon span:first-child{padding-left:0;border-left:0;color:#b8f5ff}.system-ribbon i{width:6px;height:6px;border-radius:50%;background:#58f0bf;box-shadow:0 0 10px #58f0bf}
@media(max-width:700px){.welcome-strip{padding:25px 21px}.range-controls{grid-template-columns:1fr;gap:11px}.top-actions a{width:38px;height:38px}}
</style>
</head>
<body><main class="login-shell"><section class="brand-panel"><div><div class="micro">ABOUD SYSTEM / CONTROL CENTER</div><h1>ABOUD SYSTEM</h1><p>مركز تحكم واحد لإدارة سيرفراتك، حماية مجتمعك، ومتابعة كل الأنظمة من واجهة مرتبة وسريعة.</p><div class="system-list"><span>SECURE ACCESS</span><span>DISCORD POWERED</span><span>LIVE CONTROL</span></div></div><div class="corner-mark">SYSTEM ONLINE · BUILD 2.0</div></section><section class="login-panel"><div class="panel-kicker">AUTHENTICATION REQUIRED</div><h2>أهلًا بك في مركز التحكم</h2><p>سجّل الدخول بحساب Discord المصرّح له للوصول إلى إعدادات السيرفر ولوحة الإدارة.</p><a href="/auth/discord" class="discord-button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19.54 5.04A16.9 16.9 0 0 0 15.4 3.75l-.52 1.06a15.2 15.2 0 0 0-5.76 0L8.6 3.75a16.9 16.9 0 0 0-4.14 1.29C1.84 8.94 1.13 12.86 1.49 16.73a16.8 16.8 0 0 0 5.06 2.57l1.23-1.67c-.68-.26-1.33-.58-1.94-.96l.47-.36c3.74 1.75 7.8 1.75 11.49 0l.48.36c-.62.38-1.27.7-1.95.96l1.23 1.67a16.8 16.8 0 0 0 5.06-2.57c.42-4.49-.72-8.37-3.08-11.69ZM8.24 15.23c-1.12 0-2.04-1.03-2.04-2.3s.9-2.3 2.04-2.3c1.14 0 2.05 1.03 2.04 2.3 0 1.27-.9 2.3-2.04 2.3Zm7.52 0c-1.12 0-2.04-1.03-2.04-2.3s.9-2.3 2.04-2.3c1.14 0 2.05 1.03 2.04 2.3 0 1.27-.9 2.3-2.04 2.3Z"/></svg>تسجيل الدخول عبر Discord</a><div class="secure-note"><i></i> يتم تحويلك إلى Discord الرسمي للمصادقة الآمنة</div></section></main></body></html>`);
});
...
<body>
<div class="app">
<aside class="rail" id="rail"><div class="brand"><div class="brand-mark">AS</div><div><strong>ABOUD SYSTEM</strong><small>CONTROL CENTER</small></div></div>${guildId ? '<div class="rail-section">Workspace</div><nav class="rail-nav">'+navHtml+'</nav>' : ''}<div class="rail-footer">${guildId ? safe(guildName) : 'إدارة السيرفرات'}<a href="/logout">خروج</a></div></aside>
<div class="drawer-backdrop" id="backdrop"></div>
<section class="workspace"><header class="topbar"><button class="menu-btn" id="menuBtn" aria-label="فتح القائمة"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16M4 12h16M4 17h16"/></svg></button><div class="crumb"><span>ABOUD SYSTEM / DASHBOARD</span><b>${safe(guildName)}</b></div><div class="top-status"><span class="status-dot"></span> النظام متصل</div><div class="top-actions"><a href="/dashboard" title="السيرفرات"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m4 11 8-7 8 7v8a1 1 0 0 1-1 1h-5v-6h-4v6H5a1 1 0 0 1-1-1z"/></svg></a><a href="/logout" title="تسجيل الخروج"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10 17l5-5-5-5M15 12H3M21 4v16"/></svg></a></div></header><main class="content"><section class="welcome-strip"><div><div class="eyebrow">ADMINISTRATIVE WORKSPACE</div><h1>${safe(guildName)}</h1><p>تحكم بكل أنظمة السيرفر من مساحة واحدة واضحة وسريعة.</p></div><div class="welcome-meta">LIVE / ${new Date().toLocaleDateString('en-GB')}</div></section><div class="system-ribbon"><span><i></i> Aboud System متصل</span><span>الحماية مفعّلة</span><span>لوحة التحكم · الإصدار 3.0</span></div><div class="view">${content}</div></main></section>
</div>
<script>
...
<script id="aboud-slider-enhancement">
(() => {
  const ids = [['sizeSlider','sizeOutput','px'],['xSlider','xOutput','%'],['ySlider','yOutput','%']];
  ids.forEach(([id, outputId, unit]) => {
    const input = document.getElementById(id), output = document.getElementById(outputId);
    if (!input || !output) return;
    const paint = () => {
      const min = Number(input.min || 0), max = Number(input.max || 100), value = Number(input.value || 0);
      const percent = ((value - min) / (max - min)) * 100;
      input.style.background = 'linear-gradient(90deg, #73e5ff 0%, #7267ff ' + percent + '%, #152747 ' + percent + '%, #152747 100%)';
      output.textContent = String(value) + unit;
    };
